...
%     % % Sync only
    resultsTable = table(ID,  Group,   Day,   Time,   Load, syncAccuracy, syncConsistency, power, stabilityIndex, phaseCoupling, nDayElapsed, ...
    'VariableNames',  {'ID', 'Group', 'Day', 'Time', 'Load',  'syncAccuracy', 'syncConsistency', 'Power', 'stabilityIndex', 'phaseCoupling', 'daysElapsed'});
    % Save table
    writetable(resultsTable, [pathResults '/All/statsTable_gameOrderEffect_' factorMovement{iMovement} '_Sync_noOutliers.csv'])
end
