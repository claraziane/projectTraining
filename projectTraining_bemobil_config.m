...
%% General Setup
bemobil_config.study_folder = ['/Users/claraziane/Library/CloudStorage/OneDrive-UniversitedeMontreal/Projets/projectTraining/DATA/Processed' filesep]; %(NEEDS to have a filesep at the end, sorry!) 
...
bemobil_config.raw_EEGLAB_data_folder = ['02_RAW-EEGLAB' filesep];
bemobil_config.EEG_preprocessing_data_folder = ['03_Preprocessing' filesep];
bemobil_config.spatial_filters_folder = ['04_spatialFilters' filesep];
bemobil_config.spatial_filters_folder_AMICA = ['04-1_AMICA' filesep];
bemobil_config.single_subject_analysis_folder = ['05_Analysis' filesep];
...
% bemobil_config.iclabel_classes = [1 7]; % this removes all components but 'Brain' and 'Other'
