...
# Load result table
DATA <- read.csv("/Users/claraziane/Library/CloudStorage/OneDrive-UniversitedeMontreal/Projets/projectTraining/Results/All/statsTable_gameOrderEffect_Walk_Sync_noOutliers.csv")
head(DATA)

# Define dependent variable of interest
var <- DATA$syncConsistency
